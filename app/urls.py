...
urlpatterns = [
    ...
    path(
        "authors/<int:pk>/edit/", v_authors.author_update, name="author_update"
    ),
    path(
        "authors/<int:pk>/delete/",
        v_authors.author_delete,
        name="author_delete",
    ),
    # Books
    ...
    path(
        "reviews/<int:pk>/edit/", v_reviews.review_update, name="review_update"
    ),
    path(
        "reviews/<int:pk>/delete/",
        v_reviews.review_delete,
        name="review_delete",
    ),
    # Yearly sales
    ...
    # Reports
    path("authors_table/", v_reports.authors_table, name="authors_table"),
    path(
        "top_rated_books/", v_reports.top_rated_books, name="top_rated_books"
    ),
    path(
        "top_selling_books/",
        v_reports.top_selling_books,
        name="top_selling_books",
    ),
    path("search/", v_reports.search, name="search"),
]
